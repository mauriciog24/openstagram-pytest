...
def opst_verify_login_required_fields_message(browser):
...
def opst_verify_login_valid_email_address(browser):
...
def opst_verify_login_bad_credentials_message(browser):
